...
async function translateText(text, targetLanguage) {
    const apiKey = 'Bk362ADh5Uybbzk5DRpmO0T6tAQlwcqvxw3Bm8cuJn5r2zWiJl7WJQQJ99BCACBsN54XJ3w3AAAbACOGSqYE'; // Replace with your Azure API key
    const endpoint = 'https://api.cognitive.microsofttranslator.com'; // Replace with your Azure endpoint URL
    const region = 'canadacentral'; // Replace with your Azure region (e.g., 'eastus')
    ...
    try {
        ...
        console.log("Azure Translation API Response: ", data); // Log API response
